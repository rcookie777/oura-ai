              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button onClick={register} className="btn text-white bg-blue-600 hover:bg-blue-700 w-full">Sign up</button>
                    </div>
                  </div>
                ...
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3">
                    <div onClick={signInWithGoogle} className="w-full px-3">
                ...
                <div className="text-gray-600 text-center mt-6">
                  Already using Oura.ai? <Link to="/signin" className="text-blue-600 hover:underline transition duration-150 ease-in-out">Sign in</Link>
                </div>
              </div>
